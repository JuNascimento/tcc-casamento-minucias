...
delta_x = (index_maior_valor_A[0] - 1) * step_x  + min_dx
delta_y = (index_maior_valor_A[1] - 1) * step_x  + min_dx
delta_angulo = (index_maior_valor_A[2] - 1) * step_rot + min_rot
...
# xlinha = x * cos(theta) + y * sen(theta) + delta_x
# ylinha = - x * sen(theta) + y * cos(theta) + delta_y
