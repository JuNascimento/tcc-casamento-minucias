...
def descobreDadosImagens(dadosMinucias):
  caminho_arquivo1 = os.getcwd() + '/imagens_minucias/' + \
    dadosMinucias["imagem_referencia"]["nome_arquivo"]
  caminho_arquivo2 = os.getcwd() + '/imagens_minucias/' + \
    dadosMinucias["imagem_comparacao"]["nome_arquivo"]
  ...
  print("Número de minúcias encontradas na imagem de referência -->",
    len(dadosMinucias["imagem_referencia"]["valores_minucias"][0]))
  print("Número de minúcias encontradas na imagem de comparação -->",
    len(dadosMinucias["imagem_comparacao"]["valores_minucias"][0]))
  ...
  grafico_referencia.scatter(
    dadosMinucias["imagem_referencia"]["valores_minucias"][0],
    dadosMinucias["imagem_referencia"]["valores_minucias"][1],
    c='g',
    marker='o')
  grafico_comparacao = grafico_2d_minucias.add_subplot(1, 2, 2)
  grafico_comparacao.scatter(
    dadosMinucias["imagem_comparacao"]["valores_minucias"][0],
    dadosMinucias["imagem_comparacao"]["valores_minucias"][1],
    c='g',
    marker='o')
  plt.show()
